...
// Add 'zoom follow' effect on hover ----------
const mainImage = document.getElementById('slider-main-image');
...
mainImage.addEventListener('mousemove', function (e) {
    ...
    // Calculate percentage to set the transform origin for the zoom effect
    const xPercent = (x / rect.width) * 100;
    const yPercent = (y / rect.height) * 100;

    // Set transform origin to the mouse position to follow the mouse
